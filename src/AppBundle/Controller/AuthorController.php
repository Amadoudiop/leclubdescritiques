...
class AuthorController extends Controller
{
     ...
     *
     * @Route("admin/authors/", name="author_index")
     * @Method("GET")
     */
     ...
     *
     * @Route("admin/author/new", name="author_new")
     * @Method({"GET", "POST"})
     */
     ...
     *
     * @Route("admin/author/{id}", name="author_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("admin/author/{id}/edit", name="author_edit")
     * @Method({"GET", "POST"})
     */
     ...
     *
     * @Route("admin/author/{id}", name="author_delete")
     * @Method("DELETE")
     */
